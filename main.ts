...
const elements = {
    shopEl: document.getElementById("shop-container") as HTMLDivElement,
    hampaitaEl: document.getElementById("hampaita") as HTMLSpanElement,
    fighterContainer: document.getElementById("fighter-container") as HTMLDivElement,

    shopButton: document.getElementById("shop-button") as HTMLButtonElement,
    randomButton: document.getElementById("random-button") as HTMLButtonElement
}

function summonFighter(id: number) {
